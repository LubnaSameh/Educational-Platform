...
const Users = () => {
    const users = [
        { name: "Here's the username", status: 'Active', userID: 'FE-2303', role: 'Admin', email: 'user@gmail.com' },
        { name: "Here's the username", status: 'Active', userID: 'BE-2302', role: 'Editor', email: 'usertwo@gmail.com' },
        { name: "Here's the username", status: 'Inactive', userID: 'BE-2302', role: 'Instructor', email: 'usertwo@gmail.com' },
                        ...
                        {users.map((user, index) => (
                            <React.Fragment key={index}>
                                ...
                                <tr className="d-none d-md-table-row">
                                    ...
                                    <td data-label="Status"> <span className={`${user.status === 'Active' ? 'bg-primary' : 'bg-grey'} ButtonsTable `}>
                                        {user.status}
                                    </span>
